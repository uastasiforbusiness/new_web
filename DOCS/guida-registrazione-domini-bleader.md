# 🚀 B Leader — Guida alla Registrazione dei Domini

**Documento per il cliente** · Luglio 2026
...
## 1️⃣ Creare un account su Dynadot
...
## 2️⃣ Registrare `bleaderitaly.com`
...
- **Se non lo fate entro 15 giorni, il dominio verrà sospeso.** ( SE SEI IMPEGNATO TE LO POSSO RICORDARE IO )

---

## 3️⃣ Registrare `bleaderitaly.it`
...
## 4️⃣ Riepilogo: cosa avrete alla fine

Dopo aver completato entrambi gli acquisti, avrete:

- ✅ Account Dynadot attivo con la vostra email e password
- ✅ Dominio `bleaderitaly.com` registrato e verificato
- ✅ Dominio `bleaderitaly.it` registrato con i vostri dati fiscali italiani
- ✅ WHOIS Privacy attivo su entrambi (i vostri dati personali non sono visibili al pubblico)
- ✅ Costo totale: circa **$16.77** (~15€) per il primo anno

---

## 5️⃣ Cosa dovete inviarci per completare il deploy

Una volta registrati i domini, abbiamo bisogno di queste informazioni per mettere online il sito:

### ✅ Checklist — Informazioni da inviarci
...
| 5 | **Email professionale: ne volete una?** | Es. `info@bleaderitaly.com`. Se sì, possiamo configurarvela con Google Workspace o altro provider. |
...
- **Noi**: rispondete a questa comunicazione per qualsiasi domanda o chiarimento

---

*Documento preparato per il cliente B Leader — Luglio 2026*
