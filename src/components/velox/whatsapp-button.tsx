...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 group flex items-center overflow-hidden w-14 hover:w-52 h-14 rounded-full bg-[#25D366] hover:bg-[#20bd5a] shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:shadow-[0_4px_30px_rgba(37,211,102,0.6)] transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] cursor-pointer gap-0 hover:gap-3 px-4"
      style={{ opacity: 0 }}
    >
      {/* Tooltip */}
      ...
      {/* Inline label — reveals as button expands */}
      <span className="whitespace-nowrap text-white text-[11px] font-heading font-bold tracking-[0.15em] opacity-0 group-hover:opacity-100 translate-x-2 group-hover:translate-x-0 transition-all duration-300 delay-150 pointer-events-none relative z-10">
        CHAT WITH US
      </span>
    </a>
  );
