...
export function LoadingScreen({ onComplete }: { onComplete: () => void }) {
  ...
  // Bloquear el scroll mientras dura la pantalla de carga; restaurarlo al salir.
  useEffect(() => {
  ...
  return (
    <section className="fixed inset-0 z-[9999] flex items-center justify-center overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="absolute bottom-12 left-1/2 h-[1px] w-40 -translate-x-1/2 overflow-hidden rounded-full bg-[#1a1a1a] md:w-64">
        <div
          className="loader-bar-anim h-full rounded-full"
          style={{
            background:
              "linear-gradient(90deg, transparent, #c9a96e 30%, #d4af37 50%, #c9a96e 70%, transparent)",
          }}
        />
      </div>
      ...
      <div className="relative z-10 px-6 text-center">
        <h1 className="shimmer-text font-elegant text-[64px] leading-none font-light md:text-[120px]">
          B LEADER
        </h1>
        <p className="reveal-sub mt-4 font-sans text-[10px] tracking-[0.45em] uppercase md:text-[12px] md:tracking-[0.6em]">
