    ...
    <div className="py-6 sm:py-8 border-y border-[#c9a96e]/10 overflow-hidden bg-[#0a0a0a]">
      <div ref={marqueeRef} className="flex whitespace-nowrap">
        {[...items, ...items].map((item, i) => (
          <span key={i} className="text-3xl sm:text-5xl lg:text-6xl font-elegant font-light tracking-wider text-[#1a1a1a] mx-4 sm:mx-6 select-none cursor-pointer hover:text-[#222] transition-colors duration-500 italic">
            {item}
