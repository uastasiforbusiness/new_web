...
export const CARS: Car[] = [
  {
    ...
    image: "/images/rossa_card_mediterranean.avif",
    price: "€2,450",
    priceNote: "per day",
    seats: "2",
  ...
  },
  {
    ...
    image: "/images/ferrari_california_white_background.avif",
    price: "€1,950",
    priceNote: "per day",
    seats: "2",
  ...
  },
  {
    ...
    image: "/images/maserati_card_mediterranean.avif",
    price: "€890",
    priceNote: "per day",
    seats: "5",
  ...
  },
  {
    ...
    image: "/images/mercedes_e220d_cabrio_mediterranean.avif",
    price: "€590",
    priceNote: "per day",
    seats: "4",
...
export const YACHT = {
  ...
  image: "/images/cranchi_atlantique_50_mediterranean.avif",
  specs: [
...
export const EXPERIENCES: Experience[] = [
  // ── LAND (cars) ─────────────────────────────────────────────
  {
    ...
    type: "land",
    description: "Ferrari drive to the Adriatic coast, private boat to Grotta della Zinzulusa, scenic SP358, lunch-aperitif at Canyon del Ciolo, Santa Maria di Leuca sanctuary & lighthouse. From Porto Gaio. Shoulder-season advantage: April–June and September–October, when the coast breathes.",
    image: "/images/faro.jpg",
    imagePosition: "object-[center_25%]",
    price: "from €1,900",
    duration: "Full day · custom schedule",
    highlights: ["Grotta della Zinzulusa by private boat", "SP358 clifftop drive", "Canyon del Ciolo lunch-aperitif", "Finis Terrae sanctuary & lighthouse", "Shoulder-season calm, April–June & September–October"],
  },
  {
    ...
    type: "land",
    description: "Ferrari drive on the SP108 coastal road, Porto Selvaggio & Torre Uluzzo photo stop, historic estate with olive groves and vineyards, Negroamaro Rosato welcome, \"Mani in Farina\" cooking class, lunch with handmade pasta and Primitivo/Negroamaro tasting. From Porto Gaio. Best in the quiet months — April–June and September–October.",
    image: "/images/visual-pass/experience_estate_pasta.avif",
    price: "from €1,900",
    duration: "4 hours · 10:00 – 14:00",
    highlights: ["Porto Selvaggio & Torre Uluzzo", "Historic estate & Negroamaro Rosato", "\"Mani in Farina\" cooking class", "Handmade orecchiette & minchiareddi", "Primitivo & Negroamaro tasting", "Shoulder-season calm, April–June & September–October"],
  },
  {
    ...
    type: "land",
    description: "The Ultimate Day Experience. Ferrari drive on the Ionian coast, Porto Selvaggio & Torre Uluzzo photo stop, historic estate with olive groves and vineyards, Negroamaro Rosato welcome, \"Mani in Farina\" cooking class, lunch with handmade pasta and Primitivo/Negroamaro tasting, then Half Day Charter 15:00–19:00. From Porto Gaio. Land by Ferrari, sea by flybridge — one unbroken day, paced the way you want it.",
    image: "/images/porto_selvaggio.jpg",
    imagePosition: "object-[center_30%]",
    price: "from €3,200",
    duration: "9 hours · 10:00 – 19:00",
    highlights: ["Ferrari drive · Ionian coast", "Porto Selvaggio & Torre Uluzzo", "Historic estate & Negroamaro Rosato", "\"Mani in Farina\" cooking class", "Handmade orecchiette & minchiareddi", "Primitivo & Negroamaro tasting", "Half Day Charter 15:00–19:00", "Quiet anchorages, no beach clubs"],
  },
  // ── SEA (boat) ──────────────────────────────────────────────
  {
    ...
    type: "sea",
    description: "Sant'Andrea, Gallipoli bay and Punta della Suina. Skipper & stewardess, fuel, premium aperitif, light lunch, 2 bottles prosecco/wine, water/soft drinks, snorkel, SUP, canoe. Optional tender & jet ski. Paced for slow mornings — long lunches at anchor, no itinerary pressure.",
    image: "/images/visual-pass/experience_full_day_charter.avif",
    price: "from €1,600",
    duration: "8 hours · 10:00 – 18:00",
    highlights: ["Sant'Andrea · Gallipoli bay · Punta della Suina", "Premium aperitif & light lunch aboard", "Prosecco, snorkel, SUP & canoe", "Quiet anchorages, no beach clubs", "Optional tender & jet ski"],
  },
  {
    ...
    category: "Yacht experience",
    type: "sea",
    description: "Sant'Andrea and the Gallipoli bay. Skipper & stewardess, fuel, Salentino traditional aperitif, 2 bottles prosecco/wine, unlimited water, snorkel, SUP, canoe. Optional tender & jet ski. Slow-bay pacing — the coast at its quietest hours.",
    image: "/images/visual-pass/experience_half_day_yacht.avif",
    price: "from €1,200",
    duration: "4 hours · 10:00–14:00 or 15:00–19:00",
    highlights: ["Sant'Andrea & Gallipoli bay", "Salentino traditional aperitif", "Prosecco, snorkel, SUP & canoe", "Quiet anchorages, no beach clubs", "Optional tender & jet ski"],
  },
  {
